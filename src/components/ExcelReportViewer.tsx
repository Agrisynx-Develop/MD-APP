          ...
          <div className="min-w-[1350px] border border-slate-300 bg-white p-5 select-none font-sans text-xs space-y-8">
            ...
            <div className="pt-6 border-t-2 border-black space-y-1 text-xs">
              <div className="grid grid-cols-[260px_90px_20px_130px] items-center font-semibold">
                ...
                <span className="font-mono text-right">{-totalGrandSusutProses.toFixed(3)}</span>
                <span className="text-center">:</span>
                <span className="font-mono text-right text-red-600">{-grandSusutProsesVal.toLocaleString('en-US', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}</span>
              </div>
              <div className="grid grid-cols-[260px_90px_20px_130px] items-center font-semibold">
                <span>TOTAL SUSUT JUAL</span>
                <span className="font-mono text-right">{-totalGrandSusutJual.toFixed(3)}</span>
                <span className="text-center">:</span>
                <span className="font-mono text-right text-red-600">{-grandSusutJualVal.toLocaleString('en-US', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}</span>
              </div>
              <div className="grid grid-cols-[260px_90px_20px_130px] items-center font-bold">
                <span></span>
                <span className="font-mono text-right text-red-700">{-totalGrandSusut.toFixed(3)}</span>
                <span></span>
                <span className="font-mono text-right text-red-700">{-(grandSusutProsesVal + grandSusutJualVal).toLocaleString('en-US', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}</span>
              </div>
              ...
              <div className="grid grid-cols-[260px_90px_20px_130px_60px] items-center font-black text-red-600">
                ...
                <span className="font-mono text-right">{-totalGrandSusutProses.toFixed(3)}</span>
                <span></span>
                <span className="font-mono text-right">{-grandSelisihVal.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
